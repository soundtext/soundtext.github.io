...
| Route | Page |
|---|---|
| `/` | Homepage with the TTS reader and knowledge base |
| `/about` | About Sound of Text |
| `/guides` | Guide index |
| `/guides/<slug>` | Individual guide page |
| `/privacy` | Privacy Policy |
| `/disclaimer` | Disclaimer |

Maintained by **Appz** (dev@appz.se). Inspired by the open-source Soundtext.org project (credited, not owned).
