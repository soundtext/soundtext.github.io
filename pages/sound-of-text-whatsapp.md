...
**Using [soundoftext.com](https://soundoftext.com)** *(supports most global languages)*:

1. Go to [soundoftext.com](https://soundoftext.com)
...
**Using [Sound of Text WA](https://soundtext.github.io/)** *(adds Javanese & Sundanese support)*:

1. Go to [Sound of Text WA](https://soundtext.github.io/)
2. Enter your text, select the language
3. Click **Convert to Voice** → **Download**
